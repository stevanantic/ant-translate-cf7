<?php
/**
 * Polyglot Translate for Contact Form 7 – License handler (free addon).
 *
 * Extends PGT_Addon_License_Base but overrides is_active() to always
...
class PGT_CF7_License extends PGT_Addon_License_Base
{
    /** @var self|null */
    ...
    {
        return 'polyglot-translate-cf7';
    }

    protected function option_key(): string
    {
        return 'polyglot_addon_lic_cf7';
    }

    protected function addon_name(): string
    {
        return 'Polyglot Translate for Contact Form 7';
    }
